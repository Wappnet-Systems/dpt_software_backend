...
class CreateProjectsMaterialsTransferRequestsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('projects_materials_transfer_requests', function (Blueprint $table) {
            $table->charset = 'utf8';
    ...
    {
        Schema::dropIfExists('projects_materials_transfer_requests');
    }
}
